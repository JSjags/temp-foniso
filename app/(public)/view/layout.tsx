    ...
    <div vaul-drawer-wrapper="" className="bg-background !h-0">
      <div className={cn(fontSans.variable)}>
        ...
        >
          ...
          <div className="mx-auto w-full flex justify-center gap-0 min-[480px]:gap-2 bg-[##E0E5E2] dark:bg-bgEffect max-w-[1231px] border-x border-border h-screen overflow-y-scroll">
            {/* <LeftSideBar /> */}
            {/* max-w-[740px] */}
