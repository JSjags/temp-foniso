...
const Titlebar = (props: Props) => {
  ...
  return (
    <>
      {["community"].every((v) => !pathname.includes(v)) && (
        <div className="flex items-center justify-between px-2 h-12 sticky top-0 z-[1000] bg-background border-b border-border min-[480px]:hidden">
