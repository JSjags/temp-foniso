...
const SuccessToast = ({ t, message, title }: Props) => {
  return (
    <div
      className={`${
    ...
    >
      <div className="flex-1 w-0 p-2 min-[480px]:p-4">
        <div className="flex items-start">
          ...
          <div className="ml-3 flex-1">
            <p className="text-sm text-colorPrimary font-semibold">
              {title ?? "Success"}
            </p>
      ...
      <div className="flex min-[480px]:border-l border-border">
        <button
          ...
          className="hidden w-full border border-transparent rounded-none rounded-r-lg p-4 min-[480px]:flex items-center justify-center text-sm font-medium text-foreground/70 hover:text-foreground focus:outline-none focus:ring-2 focus:ring-colorPrimary"
        >
          Close
        </button>
        <button
