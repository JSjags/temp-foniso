...
const NoticeToast = ({ t, message, title }: Props) => {
  return (
    <div
      className={`${
    ...
    >
      ...
      <div className="flex min-[480px]:border-l border-border">
        <button
          ...
          className="hidden w-full border border-transparent rounded-none rounded-r-lg p-4 min-[480px]:flex items-center justify-center text-sm font-medium text-foreground/70 hover:text-foreground focus:outline-none focus:ring-2 focus:ring-amber-500"
        >
          Close
        </button>
        <button
